            ...
            return (
              <Reveal key={service.title} delay={Math.min(index * 0.04, 0.22)} className="h-full">
                <motion.article
                  ...
                  className="group flex h-full flex-col overflow-hidden rounded-[1.5rem] border border-[var(--border-soft)] bg-[var(--surface-light-elevated)] shadow-[0_20px_60px_-44px_rgba(11,37,64,0.65)] transition-colors hover:border-[var(--brand-gold)] dark:bg-[var(--surface-dark-elevated)]"
                >
                  <div className="overflow-hidden bg-slate-100 dark:bg-white/5 border-b border-[var(--border-soft)] aspect-video w-full">
