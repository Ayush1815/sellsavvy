...
export function AboutHero() {
  return (
    <section className="relative overflow-hidden pt-28 pb-16 sm:pt-36 sm:pb-24 border-b border-[var(--border-soft)]">
        ...
        <div className="grid gap-12 lg:grid-cols-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7">
            <Reveal>
              ...
              <h1 className="text-balance text-[2.5rem] font-black leading-[1.1] tracking-tight text-slate-950 sm:text-5xl lg:text-6xl dark:text-white">
