      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid gap-8 sm:gap-12 lg:grid-cols-2 lg:gap-16 items-center">
          ...
          <Reveal delay={0.2} className="relative aspect-square max-w-[500px] mx-auto w-full lg:max-w-none">
            ...
            <img 
              src="/media/about/ecommerce_isometric_system.webp" 
              alt="High-end isometric illustration of interconnected e-commerce, digital marketing, and media production systems with glowing interconnected nodes" 
